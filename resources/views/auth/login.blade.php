...
<header class="container-fluid">
    <div class="row">
      ...
      <p class="font-weight-bold">"La calidad te hace especial"</p>
        <img src="{{asset('img/siete.jpg')}}" class="mx-auto d-block" width="1050px" height="460" alt="">
      </div>
    </div>
  </header>
  <br><br>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style=" background: -webkit-radial-gradient(purple,mediumaquamarine,pink);">
                ...
                <div class="card-body" style=" background: -webkit-radial-gradient(mediumaquamarine, pink,yellow);">
    ...
    <div class="contenedor-anuncios">
      <div class="container">
        <div class="card-group">
          <div class="card">
            <img src="{{asset('img/diez.jpg')}}" width="368px" height="280" alt="">
          ...
          <div class="card " style="background-color: LightPink;">
            <img src="{{asset('img/nueve.jpg')}}" width="368px" height="280" alt="">
            <div class="card-body">
              <h5>
          ...
          <div class="card " style="background-color: 	HotPink;">
            <img src="{{asset('img/cho.jpg')}}" width="368px" height="280" alt="">
            <div class="card-body">
              <h5>
